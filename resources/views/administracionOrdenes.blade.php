                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#editOrder"  data-bs-whatever="{{ $typeOrder->nombre}}">Editar
                                </button>
                            </td>
                            <td>
                                <form action="{{ route('tipoOrden.update', ['tipoOrden' => $typeOrder->id]) }}"
                                    method="post">
                                    @method('PUT')
                                    @csrf
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-md-11">
                                                        <label for="nameOrder" class="form-label">Nombre de la
                                                            orden</label>
                                                        <input type="text" class="form-control" id="nameOrder"
                                                            name="nameOrder" required>
                            ...
                            <td>
                                <form action="{{ route('tipoOrden.destroy', $typeOrder->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
...
<div class="modal fade" id="createorder2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3 needs-validation" method="POST" action="{{ route('tipoOrden.store') }}">
                    @csrf
                    <div class="col-md-11">
...
<script>
    ...
    if (modalAssign) {
        modalAssign.addEventListener('show.bs.modal', event => {
            ...
            const modalBodyInput = modalAssign.querySelector('#nameOrder')
